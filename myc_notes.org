* type of mycel radio modules

transmitters: transistor(switchable), HC04

with input to trans or HC04 from:

- micro with humidity, MAXtemp, CO2, 555 in, ADC mushroom, ADC from AD620 earthboot(TEST), 5933 from earthboot (7 options)
- 555 out
- 4093/theremin out
- OP07 RF out

- 4093 HF as standalone transmitter
...
* other TODO for TAIPEI

- distributed PSU so we don't short all if there is a problem
- receiver modules
- soundcard setup and tests
...
- playing with this and further ideas
- reception
...
- printed reader
- dried lingzhi for tea
- copper wires 0.8mm and 1mm
- several arduinos, cables and receiver modules
- audio cables
- vinyl cutter
- radio receivers
- copper sheets, thin boards, copper sticky sheets, basic wire, solder, croc clips, 
- parts boxes just in case...

- 8x 9v batteries

- tools-solder iron, multimeter
- mycelium modules, sensors, *power supply* and breakout, programmer and cable

- candles and for heating, laser and light pickup

what to order/buy: thin copper boards, parts, power supply 5v ???, copper sheets (mod), croc clips, batteries, parts:

- parts: battery clips, 04: HC04, 10u, 4.7K, 47k, 1k, 2.5k, 33pfx2,
  10pf, 2.5k trimmer, theremin transmit: 4093, 15k, 100pf,
  transistor-based:2n2222, 470R, 27K, 10K, 1N, wire 0.8, 1mm

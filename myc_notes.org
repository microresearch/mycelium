...
thin copper boardsX, parts, *several power supply 5v for arduino and modules*, copper sheets (mod), croc clipsX, batteries, parts:

- parts: battery clips-3xaaaX, 04: HC04 (note 5v only)x, 

check: 4.7K, 47k, 1k, 2.5k, 470R, 27K, 10K, 15K

check: 33pfx2, 10pf, 100pf, 1N, 10u

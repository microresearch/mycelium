...
being in a forest
being a forest
mycelium beneath and here above
...
FM radio if you have one (otherwise these will be supplied), notebook, pen

a small, portable setup for performing, a few objects, a fragment of a score which connects you personally to mushrooms or mycelial networks 

...
1-micro/HIH-humidity SDcard-built
2-micro/MAX-temperature SDcard-built
...
17-OP07->transistor (no 3.3v, no micro)
...
*so maybe 16 with micros max and spares! - we can build 13 micros+2 built=15*

how many MCP602=20-3(built)=18 (we have only 8 mcps left?)

** basic test setup

- micro: sensor in, serial out
...
- alcohol for cleaning or clean first

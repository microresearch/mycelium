...
- micro with humidity, MAXtemp, CO2, light(TODO), 555 in, ADC mushroom, ADC from AD620 earthboot(TEST), 5933 from earthboot (8 options)
- 555 out
- 4093/theremin out
- OP07 RF out
...
- copper wires
- arduinos and receiver modules
- vinyl cutter and copper?
...
- test other sensors/AD5933: CO2, light, ADC mushroom, ADC from AD620 earthboot(TEST), 5933 from earthboot
